      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <div className="magic-card p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="magic-button bg-indigo-600 hover:bg-indigo-700 flex items-center gap-2">
          ...
          <div className="mt-12 flex flex-col items-center">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-indigo-200 hover:text-blue-300 transition-colors group">
              ...
              <a href="#" className="text-indigo-200 hover:text-blue-300 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
